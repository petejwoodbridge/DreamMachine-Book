...
## Full marketing description (600 words)
...
**Genre:** Non-fiction / Technology & Society / Media & Creative Industries / Business & Strategy

**Comp titles:**
- *The Coming Wave* — Mustafa Suleyman (Penguin, 2023) — the macro-AI book; this is the creative-industries equivalent
- *AI Snake Oil* — Arvind Narayanan & Sayash Kapoor (Princeton, 2024) — the evidence-based AI critique; *Dream Machine* is the practitioner-side companion
- *The Creative Act* — Rick Rubin (Penguin, 2023) — the artist's interior manual; *Dream Machine* is its 2026 institutional and economic counterpart
- *No Filter* — Sarah Frier (Simon & Schuster, 2020) — the inside-the-platform-transition model; *Dream Machine* is the same for the AI-creative transition
- *Smart Brevity* — Jim VandeHei et al. (Workman, 2022) — the working-practitioner business-book model; similar register
- *Filterworld* — Kyle Chayka (Doubleday, 2024) — the culture-and-algorithms genre; *Dream Machine* extends the frame to AI generation

**Sits alongside on the shelf with:** *The Master Switch* (Tim Wu), *Brotopia* (Emily Chang), *The Attention Merchants* (Tim Wu), *Hit Makers* (Derek Thompson), *The Anxious Generation* (Jonathan Haidt). Picked up by readers of Ben Thompson's *Stratechery*, Casey Newton's *Platformer* and Charlie Warzel's *Atlantic* AI coverage.

**Comp titles' length:** *The Coming Wave* — 352 pages. *AI Snake Oil* — 360 pages. *No Filter* — 384 pages. *Dream Machine* — roughly 200,000 words, comparable to a 480-page hardback in standard non-fiction trim.

---

## Key audiences

1. **Working creatives** — film, television, music, games, advertising, design, publishing, broadcast, journalism. The primary market. Roughly 50–80 million people globally in 2026 by the broadest count. The book has been written for this reader first.
2. **Creative-industry leadership** — studio executives, agency leadership, label A&R, publisher commissioning editors, broadcast commissioning, platform creative VPs. The secondary market. ~500,000 globally.
3. **Policy, union, institute and platform people** — the rule-writers and platform-builders. ~100,000 globally. A small market by absolute numbers but the highest-leverage in terms of cultural influence.
4. **Adjacent professionals reading for cultural literacy** — tech-industry workers, investors, journalists, academics, students — who want one comprehensive book on the AI-and-creative transition to recommend to others. Potentially a multi-million reader pool.
...
He lives and works in the North West of England.
...
## Five things the press should know

1. **The book is the only published account written from inside the AI-creative transition by a practitioner running an AI-augmented studio at the same time.** The combination of working studio operator, weekly newsletter-writer and framework-builder produces a vantage point no journalist, academic or platform-company spokesperson has been able to match through the period.

2. **The "age of the *How* / age of the *Why*" framing is the book's signature contribution.** Borrowed from elite chess — where AI has driven the game towards perfect play, and grandmasters now win by deliberately playing sub-optimal moves the engine would not recommend — the argument reframes the entire creative-AI debate around the deeply human acts of taste, intent, authenticity and risk-taking that AI, by construction, cannot replicate.

3. **The Slop Ceiling at 44 to 3.** The book's most-cited single number is Deezer's April 2026 disclosure that 44% of new music uploads were AI-generated, but those tracks captured no more than 3% of total streams. The Slop Ceiling — Woodbridge's coined term for this dynamic — describes the audience's reliable underweighting of synthetic content, and is documented across music, film, games, podcasting and advertising in chapter-length detail.

4. **The Petrillo template applied to AI.** The book makes the historical case that every previous creative-technology resistance has settled at a *levy-and-redistribute* mechanism rather than a prohibition — and that the SAG-AFTRA Tilly Tax, the UK 88%, the GEMA ruling and the Cannes Disclosure Standard are, structurally, attempts to rebuild James Caesar Petrillo's 1948 Music Performance Trust Fund settlement for the AI era. The book provides the working policy framework for what this should look like in 2027.
...
> "Working creatives need to open the black box of AI and own a real stake in how it is built. Not just use it. Not just refuse it. Open it."
> *— Chapter 3*

> "Levy beats ban. Royalty pool beats injunction. Mechanism beats prohibition."
> *— Chapter 2*
...
## Hashtag and social positioning

**Primary hashtag:** `#WelcomeToTheDreamMachine`

**Secondary tags:** `#AgeOfTheWhy` `#SlopCeiling` `#TheOrchestrator` `#CreativeAI` `#DreamMachine`

**Author social:** Pete Woodbridge — LinkedIn (primary), the *Dream Machine* newsletter at [linkedin.com/newsletters/dream-machine-creative-ai-7379776527871381505](https://www.linkedin.com/newsletters/dream-machine-creative-ai-7379776527871381505/), and the DreamLab AI Collective.

---

## Suggested cover treatment notes

**Title typography:** *Dream Machine* in a contemporary serif (Mrs Eaves, GT Sectra, Tiempos) — the typographic register of cultural-history non-fiction rather than tech-business. Subtitle *The New Creative Economy* in a lighter weight beneath.
...
**Comparable cover treatments:** *The Coming Wave* (Bodley Head edition), *Filterworld* (Doubleday), *Chip War* (Scribner). Restrained, typographic-led, suggesting institutional weight rather than tech novelty.

**Print specifications:** Hardback first edition, 480pp at standard non-fiction trim, including 32pp of front matter and 80pp of appendix material. Paperback edition with revised epilogue to follow 12 months later.

---

*Marketing copy © 2026 Pete Woodbridge / DreamLab AI Collective. Press enquiries: through the Dream Machine newsletter or the DreamLab AI Collective contact page.*
