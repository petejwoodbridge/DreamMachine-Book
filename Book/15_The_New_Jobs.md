...
There is one further reading of the aggregate data worth holding onto, because it reframes the whole displacement question. *Labor Market Matters*, in a July 2026 analysis built on seven charts of independent-work data, argued that AI's first labour-market effect may not be replacing workers at all — it may be making *traditional firms less necessary*, accelerating the long shift toward independent and freelance work.[^54] If that reading is right, then a good part of what shows up in the statistics as "job losses" is actually *employment changing shape*: the same work, and often the same worker, migrating out of the payroll column and into the independent one. For the creative industries — which were already the most freelance-heavy sector of the economy before the transition began — this is less a foreign invasion than an intensification of the existing weather. It also explains why the headline employment figures and the lived experience of working creatives can diverge so sharply: the firm-shaped jobs are contracting faster than the work is.

### The roles that are disappearing

I want to be specific, because vague claims about "creative jobs disappearing" do not help anyone make a career decision. Based on the trade-press coverage tracked across the *Dream Machine* archive, the shadow-AI and adoption-dynamics survey data underlying DreamLab's research, and the studio-leadership interviews I have read or conducted, the roles under the most active substitution pressure in 2026 are:

**Junior visual production roles.** Concept artists at the asset-variation level. Junior 3D modellers doing standard architectural / environmental fills. Storyboard artists working on commercial briefs that do not require performance staging. Background-plate compositors. Routine matte painters. Stock photographers and stock illustrators. Adobe's own data — 25% of new Adobe Stock contributions in 2024 containing Firefly-generated elements[^5] — is the clearest single number in this category.
...
**Mid-career routine production and post-production roles.** Routine audio engineering (the 1,100-creator music survey discussed in Chapter 14 showed 58% of producers using AI for restoration, 38% for mixing assistance, 33.9% for automated mastering[^7]). Standard VFX compositing (62% of Hollywood studios on automated AI compositing, 35% reduction in post-production timelines[^8]). De-aging specialists (200 hours per actor down to 50). Particle simulation specialists (68% adoption among top VFX houses by SIGGRAPH 2025). Routine matte-painting generalists (initial setup time from 4 hours to 1.2 per shot).

**Routine games-development roles.** Square Enix's announced target — **70%** of QA work via AI by end of 2027 — is the cleanest signal here.[^9] Falcom's reported productivity ratio of *2-3 hours of work reduced to 10 minutes*[^10] tells you what is happening to the routine animation, asset and engineering layer underneath the games industry. Ubisoft's January 2026 cancellation of five games (including the *Prince of Persia* remake) in order to refocus capital on AI signalled a structural shift in resource allocation that mid-career game developers are still digesting.[^11]

**In-house AI specialist teams at non-AI-native companies.** This one is counter-intuitive but real. The publisher behind *Grand Theft Auto VI* laying off its entire seven-year-old internal AI team in April 2026, in favour of off-the-shelf tooling, is the canonical case.[^12] Companies that built proprietary AI capabilities in 2018–2024 are increasingly finding that the open-weight and commercial foundation models have caught up; the bespoke AI team becomes redundant. This is a real and rapid form of AI-driven displacement that the public discourse has not yet recognised, because the workers being displaced are themselves AI specialists.

**Voice actors and session musicians in commodity work.** ElevenLabs' growth to $500m ARR by April 2026[^13] is, in large part, the substitution of routine voiceover, audiobook, podcast-host and dubbing work. Live performance, voice work that requires acting craft, and specialty voice roles (animation leads, signature character voices) are not displaced. The middle of the voice market is.

**Routine commercial illustration and design.** Brand assets, marketing imagery, social-media graphics, basic product visualisation. The Higgsfield growth curve — $200M revenue in nine months, primarily serving social-media marketers[^14] — is the consumer-marketing equivalent of the Adobe Firefly enterprise curve.
...
**AI orchestrators / senior creative directors of agentic teams.** The most strategically important new role, and the one Chapter 12 made the long-form case for. The Sony 49-Claude-agent / 72-skill stack is the canonical example.[^15] In adland, *Digiday* reported in late 2025 that "AI agent developers have become adland's in-demand role"[^16] — a senior creative-strategic role that did not exist eighteen months earlier. By Cannes 2026 the demand signal had become theatrical: PMG ran a hackathon at the festival itself, using adland's flagship week to recruit and showcase AI-fluent talent, and *Ad Age* read it, correctly, as a signal of agencies' growing appetite for people who can *build* with the tools rather than merely approve work made with them.[^48]

**Prompt engineers / AI workflow designers.** The role is now broad enough to have its own specialisation tracks. *Forbes* reported in November 2025 that "vibe coding" — natural-language software development — paid up to **$220,000** as an in-demand AI skill.[^17] The equivalent figures in the creative space — prompt engineers at major studios, freelance AI-workflow consultants — are running in the same band for senior practitioners.

**AI literacy trainers and AI-education designers.** The Sundance Institute's AI Literacy Initiative, launched in January 2026 with $2M of Google funding to train 100,000 filmmakers, is the institutional version of this role.[^18] The Adobe Ignite Day at Sundance, the UK government's "Free AI training for all" programme covering 10 million workers by 2030,[^19] the Lovable-for-classrooms expansion,[^20] the UW-Stout baseline-AI competency course[^21] — these are the demand signal for a new category of educator that combines creative-discipline expertise with practical AI fluency. The pipeline keeps widening. In June 2026 Anthropic launched **Claude Corps**, a fellowship that will teach 1,000 fellows to master Claude and match them with nonprofits across America — a platform company building, in effect, a subsidised entry route into orchestration work, with the civic sector as the training ground.[^49] The same month, the UK published its **AI Adoption Plan for the Creative Industries**, the skills-and-adoption half of the government's creative-AI policy (the copyright half belongs to Chapter 6), formalising sector-specific adoption support and training as national policy rather than platform philanthropy.[^50]

**Model curation specialists.** With foundation models proliferating and custom fine-tuning becoming a baseline capability, the role of *selecting, training and maintaining* an organisation's model stack has emerged as a discrete specialism. Adobe Firefly Foundry — the service that lets companies train custom generative models on their own visual identity[^22] — created an entire job category of brand-and-IP model trainers. Korin AI's launch in May 2026, "trained with African datasets, built by Africans,"[^23] is the cultural-fluency variant of this role.

**AI ethics, disclosure and provenance officers.** Following the SAG-AFTRA contract negotiations, the Cannes AI Disclosure Standard, the Academy's "you must be human to win" rule, the New York AI advertising disclosure law, and the proliferating C2PA-compliance and SynthID-tooling requirements, organisations across the creative industries have begun hiring (or designating) dedicated AI-ethics and disclosure leads.[^24] At DreamLab, we have a *Continuum Lead* whose job is to make this work coherent across every project we run — three years ago, the role did not exist.

**Indie and Global South creator-producers.** The cost reduction in production tooling has created a new viable role category that was not economically possible before: the *one-person-or-small-team creator-producer* operating outside the traditional creative centres, with global distribution reach and a defensible aesthetic identity. *Forbes* covered the broad category in "AI Is Changing How Creators Work And Earn" in December 2025.[^25] The Higgsfield revenue (built on social-media marketer demand), the Andrii Daniels bomb-shelter clip (a Ukrainian one-person production with global reach[^26]), the Tunisian *Lily* ($1M Dubai AI Film Award winner[^27]), the Indonesian *Legenda Bertuah* animated series,[^28] the Indian-cinema integration wave covered by the BBC's "Lights, camera, algorithm"[^29] — these are not exceptions. They are the leading edge of a structural change in *who can be a working creative*, and where they can live.

**AI training and evaluation work.** The new job category with the bitterest edge. *The Hollywood Reporter* reported in June 2026 that Hollywood workers — writers prominent among them — are increasingly taking work *training AI models* as conventional job prospects grow slim: annotating scripts, evaluating outputs, teaching the systems the craft conventions of the industry contracting around them.[^51] The role is real, it pays, and it is growing fast. It is also the most uncomfortable entry on this list, for two reasons. The first is that the labour is directed at improving the very substitutes applying the displacement pressure — the screenwriter grading model outputs is, in the most literal sense, training their own competition. The second is who the role is absorbing: exactly the early-and-mid-career practitioners the apprenticeship pipeline used to carry. A junior writer spending their formative years rating completions is building a kind of AI literacy — but it is literacy in the service of someone else's system, on someone else's terms, with none of the mentorship, authorship or craft progression the old junior rungs carried. I list it as an emerging role because honesty requires it. I decline to celebrate it.
...
The most direct number arrived in June 2026, and it put a price on the premium. PwC's analysis of the UK labour market, reported by *UKTN*, found AI hiring surging *across all UK sectors* — not just tech — with roles demanding AI skills carrying a **34% salary premium** over equivalent roles without them.[^52] I have been making the AI Literacy Premium argument since the autumn of 2025 as a structural claim about where leverage was moving. The PwC finding is that claim showing up in the payroll data: a third more, for the same discipline, in the same market, for the practitioner who can direct the tools. If a single statistic in this chapter deserves to be pinned above a working creative's desk, it is that one.

The Adobe Creators' Toolkit Report of October 2025, surveying 16,000 creators across the U.S., U.K., France, Germany, South Korea, Japan, India and Australia, found that **86%** of creators were already using generative AI; that **76%** of users said it had helped grow their business or brand; that **81%** said AI lets them make content they otherwise could not have made; and — most significantly — that **70%** were optimistic about agentic AI and **85%** would use AI that learned their creative style.[^32] The numbers are not the numbers of a workforce in retreat. They are the numbers of a workforce *adopting at scale* and reporting commercial benefit.

The PRS for Music 2026 AI Survey, surveying U.K. music creators, found **four in five** music creators worried about AI-generated music competing in the streaming economy[^33] — but also that respondents who were using AI tools in their own creative practice reported higher earnings and broader output reach than peers who were not. The two findings live together. The anxiety and the adoption are happening in the same head.

The U.K. Department for Business and Trade research, reported in *CNBC* in November 2025, found that workers with ADHD, autism and dyslexia were **25% more satisfied** with AI assistants than neurotypical workers, with AI agents reported as actively helping them succeed at work.[^34] Given that the creative industries are over-indexed on neurodivergent talent compared with the general population, this is a major equity-and-productivity story that the AI-displacement narrative has under-told.

The McKinsey AI report on film and TV production, released in early 2026, made the broader business case: AI would not, in McKinsey's view, replace film and television production. It would *restructure* it — towards smaller teams, faster cycles, more iteration, and heavier reliance on senior creative judgement.[^35] In other words: towards an *orchestrator-shaped* industry, in which the working creatives best positioned to thrive are those who can operate the new toolchain rather than those who refuse to engage with it.

The GDC State of the Game Industry surveys 2024–2026 showed personal generative-AI usage among professional game developers rising from **31%** to **36%** while industry sentiment cratered from 18% negative to **52%** negative.[^36] The full trajectory of that sentiment number deserves spelling out, because it is one of the most striking curves in the entire labour dataset: **18%** of developers said generative AI was having a negative impact on the industry in the 2024 survey, **30%** in 2025, **52%** in 2026 — the negative share nearly tripling in two years, over exactly the period in which adoption *grew*.[^36a] The interpretation: developers using AI are increasingly *uncomfortable* about doing so, but they are doing so anyway, because the productivity advantage is too strong to ignore. Sentiment and behaviour are running in opposite directions, and behaviour is winning.

The employer side of the same story is now being told in an unexpectedly warm register. **EA** told *PC Gamer* in June 2026 that AI is delivering "faster prototyping" and a "real rise in creativity" across its studios.[^53] Take the framing with the scepticism that employer testimony always deserves — "a rise in creativity" is doing public-relations work for a company that has been aggressive about AI integration — but notice what the claim concedes. The employer case for AI is no longer being made in cost-reduction language alone. Employers are competing to describe their AI-augmented workforces as *more creative*, which tells you, at minimum, what they believe the AI-literate practitioner is worth to them — and which side of the literacy line they intend to hire from.

The LANDR study reported in *Ari's Take*, late 2025, found that **87%** of musicians surveyed were using AI tools in some part of their practice.[^37] When the figure for "musicians using AI" approaches the figure for "musicians using DAWs," you are not looking at a niche adoption pattern. You are looking at a baseline competency that the next generation of working musicians will be assumed to have.

The Stanford AI Index Report 2025 found that across 26 surveyed nations, **55%** of individuals viewed AI products as offering more benefits than drawbacks, up from 52% in 2022[^38]; the YouGov 2024 multi-market sentiment data echoed the same direction.[^39] Working creatives are sitting inside a consumer environment that is, on net, *increasingly accepting* of AI in creative work — which translates, slowly, into client demand for AI-augmented services.

The *Digital Music News* survey of nearly **800 creatives** who signed the *Stealing Our Work Is Not Innovation* declaration in January 2026[^40] — that same vocal-minority signal that produced political wins in Chapter 6 — included, in its signatory base, a meaningful number of creators who were *themselves* using AI tools in their own production work. The signing of the declaration was not a refusal of the technology. It was an insistence that the *training data* be consented and compensated. Two positions, held at once, by the same working creatives.
...
And the displaced junior layer is not waiting quietly while the industry deliberates. It is going to work for the other side. The Hollywood-workers-training-AI-models story I flagged in the emerging-roles list above[^51] is the Apprenticeship Gap expressed as a labour flow: the would-be apprentices of 2026, unable to find the junior rungs, are spending their formative years teaching the systems that absorbed the rungs beneath them. Every hour of craft knowledge that flows into the models through that channel is an hour that used to flow, through mentorship, into the next generation of practitioners. The gap is not just failing to train the 2035 cohort. It is actively transferring the training substrate somewhere else.
...
The Tunisian-made *Lily* winning the $1M Dubai AI Film Award.[^41] The Ukrainian one-person bomb-shelter production going viral globally.[^42] The Indian-cinema AI integration wave covered by the BBC, with productions across regional cinema centres absorbing the new toolchain at scale.[^43] The Indonesian *Legenda Bertuah* AI-animated series.[^44] The Korin AI launch — Africa-trained, Africa-built foundation model — and the broader CNBC Africa coverage of AI in African music and film.[^45] The Singapore-based AI video startup Video Rebirth raising $50M for studio-grade tooling. The Eastern European AI filmmaker community building around the success of creators like Andrii Daniels. The Latin American AI-film festival wave through 2026.
