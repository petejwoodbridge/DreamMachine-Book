...
The first twelve chapters were about the transition. This chapter is about the tools.
...
**Generative music tools** that produce finished tracks from prompts — **Suno** (Studio launched late 2025[^13]), **Udio**, **Mureka** (with its Music Agent Studio, six specialised AI agents for songwriting, arrangement and production[^14]). These are the tools that produce most of the AI-music flood Chapter 4 describes. They are also, paradoxically, the tools most working musicians use the least directly — the consumer market for AI-generated finished tracks is large and growing, but professional musicians overwhelmingly use AI tools at a different layer.
...
The category that, more than any other, I think defines the next decade of creative work. Chapter 7 is the long-form argument; this section is the inventory.
...
The category I think most working creatives are still underestimating, six months after Chapter 2 argued it was the inflection point of the era.
...
4. A judgement layer (the human at the desk, doing what Chapter 9 calls *briefing, allocating, judging and integrating*).
...
**Adobe** — I have written enough about Adobe in Chapter 8 that I will not repeat it here. The short version: Creative Cloud is, today, a stack of AI agents wearing a Photoshop / Premiere / After Effects / Illustrator / InDesign / Acrobat skin. The agents are inside the apps; the apps are inside ChatGPT; the apps are inside Adobe Express; the apps are inside the new CX Enterprise platform. The repositioning is complete.
...
- **Fortnite** — Chapter 7 AI-art controversy; Disney partnership.
...
- **Brief-First, Generate-Second** — the workflow practice the book argues for in Chapter 9 (and Chapter 14's *toolchain in layers* section below).
...
[^18]: Music industry AI deal flow, October 2025 – May 2026. See Chapter 4 footnotes 31–37, and *Dream Machine* Issues [5](../Dream%20Machine%20MD/5.md), [7](../Dream%20Machine%20MD/7.md), [8](../Dream%20Machine%20MD/8.md), [12](../Dream%20Machine%20MD/12.md), [14](../Dream%20Machine%20MD/14.md), [16](../Dream%20Machine%20MD/16.md), [17](../Dream%20Machine%20MD/17.md).
